                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            <thead><tr><th hidden="">Id</th><th>Fecha de creación</th><th>Medico</th><th>Descripción</th><th>Tratamiento</th><th hidden="">Historial</th></tr></thead>
                                                        <%
                                        ...
                                        <%} else {%> <h1 class="gradeA">No tiene historial</h1><%}%>
                                    </div>
                                </div>
                            </div>
                        </div>                
